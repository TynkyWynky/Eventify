...
const messages = {
  en: {
    ...
    "langModal.hint": "You can always change this later in the footer.",
  ...
  fr: {
    ...
    "langModal.title": "Choisissez votre langue",
    "langModal.hint": "Vous pouvez toujours la modifier plus tard dans le footer.",
  ...
  nl: {
    ...
    "langModal.title": "Kies je taal",
    "langModal.hint": "Je kan dit later altijd wijzigen in de footer.",
