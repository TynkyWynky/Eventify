...
const messages = {
  en: {
    ...
    "auth.passwordMin": "Use 10+ characters with uppercase, lowercase, a number, and a symbol.",
    ...
    "auth.error.passwordMin": "Password must be 10+ chars and include uppercase, lowercase, a number, and a symbol.",
    "auth.error.passwordMatch": "Passwords do not match.",
    "auth.error.registerFailed": "Register failed.",
    "auth.error.resetRequestFailed": "Could not send reset instructions.",
    "auth.error.resetPasswordFailed": "Could not update your password.",
    "auth.validation.good": "Looks good",
    "auth.validation.bad": "Not valid yet",
    "auth.forgotPassword": "Forgot password?",
    "auth.forgotPasswordTitle": "Reset your password",
    "auth.forgotPasswordHint": "Enter your email and we'll send you a secure reset link.",
    "auth.forgotPasswordAction": "Send reset link",
    "auth.forgotPasswordLoading": "Sending reset link…",
    "auth.forgotPasswordSuccess": "If an account exists for that email, we've sent a password reset link.",
    "auth.resetPasswordTitle": "Choose a new password",
    "auth.resetPasswordHint": "Set a new password for your Eventium account.",
    "auth.resetPasswordAction": "Update password",
    "auth.resetPasswordLoading": "Updating password…",
    "auth.resetPasswordSuccess": "Password updated successfully. You can now log in.",
    "auth.resetPasswordMissingToken": "This reset link is missing or invalid.",
    "auth.backToLogin": "Back to login",
    "auth.resetDebugLabel": "Dev reset link:",
    ...
    "dash.distance.all": "All distances",
    "dash.distance.enable": "Enable distance filter",
    "dash.distance.disable": "Show all distances",
    "dash.loading.events": "Loading events…",
    "dash.event.one": "event found",
    "dash.event.many": "events found",
    "dash.banner.near": "near",
    "dash.banner.nearYou": "near you",
    "dash.banner.tonightIn": "Tonight in",
    "dash.retry": "Retry",
  ...
  fr: {
    ...
    "auth.passwordMin": "Utilisez 10+ caractères avec majuscule, minuscule, chiffre et symbole.",
    ...
    "auth.error.passwordMin": "Le mot de passe doit contenir 10+ caractères avec majuscule, minuscule, chiffre et symbole.",
    "auth.error.passwordMatch": "Les mots de passe ne correspondent pas.",
    "auth.error.registerFailed": "Échec de l'inscription.",
    "auth.error.resetRequestFailed": "Impossible d'envoyer les instructions de réinitialisation.",
    "auth.error.resetPasswordFailed": "Impossible de mettre à jour votre mot de passe.",
    ...
    "auth.forgotPasswordHint": "Entrez votre email et nous vous enverrons un lien sécurisé.",
    "auth.forgotPasswordAction": "Envoyer le lien",
    "auth.forgotPasswordLoading": "Envoi du lien…",
    "auth.forgotPasswordSuccess": "Si un compte existe pour cet email, nous avons envoyé un lien de réinitialisation.",
    "auth.resetPasswordTitle": "Choisissez un nouveau mot de passe",
    "auth.resetPasswordHint": "Définissez un nouveau mot de passe pour votre compte Eventium.",
    "auth.resetPasswordAction": "Mettre à jour le mot de passe",
    "auth.resetPasswordLoading": "Mise à jour du mot de passe…",
    "auth.resetPasswordSuccess": "Mot de passe mis à jour. Vous pouvez maintenant vous connecter.",
    "auth.resetPasswordMissingToken": "Ce lien de réinitialisation est manquant ou invalide.",
    "auth.backToLogin": "Retour à la connexion",
    "auth.resetDebugLabel": "Lien de réinitialisation (dev) :",
    ...
    "dash.distance": "Distance (Km)",
    "dash.distance.all": "Toutes les distances",
    "dash.distance.enable": "Activer le filtre distance",
    "dash.distance.disable": "Afficher toutes les distances",
    "dash.loading.events": "Chargement des événements…",
    "dash.event.one": "événement trouvé",
    "dash.event.many": "événements trouvés",
    "dash.banner.near": "près de",
    "dash.banner.nearYou": "près de vous",
    "dash.banner.tonightIn": "Ce soir à",
  ...
  nl: {
    ...
    "auth.passwordMin": "Gebruik 10+ tekens met hoofdletter, kleine letter, cijfer en symbool.",
    ...
    "auth.error.passwordMin": "Wachtwoord moet 10+ tekens hebben met hoofdletter, kleine letter, cijfer en symbool.",
    "auth.error.passwordMatch": "Wachtwoorden komen niet overeen.",
    "auth.error.registerFailed": "Registreren mislukt.",
    "auth.error.resetRequestFailed": "Resetinstructies konden niet worden verzonden.",
    "auth.error.resetPasswordFailed": "Je wachtwoord kon niet worden bijgewerkt.",
    "auth.validation.good": "Ziet er goed uit",
    "auth.validation.bad": "Nog niet geldig",
    "auth.forgotPassword": "Wachtwoord vergeten?",
    "auth.forgotPasswordTitle": "Reset je wachtwoord",
    "auth.forgotPasswordHint": "Voer je e-mail in en we sturen je een veilige resetlink.",
    "auth.forgotPasswordAction": "Resetlink sturen",
    "auth.forgotPasswordLoading": "Resetlink verzenden…",
    "auth.forgotPasswordSuccess": "Als er een account bestaat voor dat e-mailadres, hebben we een resetlink verstuurd.",
    "auth.resetPasswordTitle": "Kies een nieuw wachtwoord",
    "auth.resetPasswordHint": "Stel een nieuw wachtwoord in voor je Eventium-account.",
    "auth.resetPasswordAction": "Wachtwoord bijwerken",
    "auth.resetPasswordLoading": "Wachtwoord bijwerken…",
    "auth.resetPasswordSuccess": "Wachtwoord bijgewerkt. Je kan nu inloggen.",
    "auth.resetPasswordMissingToken": "Deze resetlink ontbreekt of is ongeldig.",
    "auth.backToLogin": "Terug naar login",
    "auth.resetDebugLabel": "Dev-resetlink:",
    "loading.aria": "Laden",
    ...
    "dash.distance.all": "Alle afstanden",
    "dash.distance.enable": "Afstandsfilter inschakelen",
    "dash.distance.disable": "Alle afstanden tonen",
    "dash.loading.events": "Events laden…",
    "dash.event.one": "event gevonden",
    "dash.event.many": "events gevonden",
    "dash.banner.near": "in de buurt van",
    "dash.banner.nearYou": "in jouw buurt",
    "dash.banner.tonightIn": "Vanavond in",
    "dash.retry": "Opnieuw",
